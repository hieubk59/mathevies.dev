...
$(window).scroll(function () { 
    if ($(this).scrollTop() < 100) {
      $(".topWoodStrip, header.main").removeClass("header-ani", 1000);
  }
  else
      $(".topWoodStrip, header.main").addClass("header-ani", 1000);
});
...
var value = 0
$("div#mobileNavIcon img").rotate({ 
 bind: 
 { 
    click: function(){
        value +=180;
        $(this).stop().rotate({ animateTo:value});
    }
} 
...
/*Dropdown arrow */
$("ul.sub-menu").hide();
$('#mainMenu li:has(.sub-menu)').addClass('hasSub');
$("ul.sub-menu").parent().append("<span></span>");

$('#mainMenu >li.hasSub').hover(function(){
    $(this).children('ul').stop().slideDown(700, 'easeOutBack');
},function(){
    $(this).children('ul').stop().slideUp(250, 'easeInOutExpo');
});

//Menu icon on mobile 
$('div#mobileNavIcon img').click(function() {
...
/*$('.services ul li').hover( function(){
    $(this).parent().children().not(this).stop()
    .animate(
        {   opacity: 0.6,
            bottom: -10 }, 250);    
}, function(){
...
$('.services ul li').hover( function(){
    $(this).parent().children().not(this).stop().addClass('ani')
}, function(){
    $(this).parent().children().not(this).stop().removeClass('ani')
});

//Google maps
var map;
var myMap = new google.maps.LatLng(44.91902,1.277855);
var image;
...
//Map Marker 
var image = 'http://www.mathevies.com/wp-content/themes/ddm/img/marker.png';
var myLatLng = myMap;
...
$('ul#accord > li > a').click(function(){
    ...
    $(this).next().slideToggle(250);
    $('ul#accord li h4').removeClass('active');
}
