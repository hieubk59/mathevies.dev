...
//update_option('siteurl','http://www.mathevies.com');
//update_option('home','http://www.mathevies.com');
...
function starkers_setup() {
    ...
    //set_post_thumbnail_size(61, 92, true); //the_post_thumbnail('thumb-image-large');
	add_image_size('main-thumb', 220, 220, true);
...
function excerptBlog($num) {
$limit = $num+1;
$excerptBlog = explode(' ', get_the_excerpt(), $limit);
array_pop($excerptBlog);
$excerptBlog = implode(" ",$excerptBlog).'...<br><br><a href="'. get_permalink($post->ID) . '" class="btn readMore">' . 'Read more' . '</a>';
echo $excerptBlog;
}
